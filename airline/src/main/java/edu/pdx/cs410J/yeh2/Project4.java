...
public class Project4 {
    ...
    /**
     * Project #4 Timestamp Formatting:
    ...
    public static void displayer(String txtfile, Integer Option)
    {
        ...
        {
            try (InputStream displayme = Project4.class.getResourceAsStream(txtfile)) {
...
//        }
    ...
    /**
     * The main class for the CS410J Project #4: Storing Airlines as XML
    ...
    public static void main(String[] args) {
        ...
        // Project #4 README4.txt file!
        final String readme_file = "README4.txt";
        ...
        if (args.length == 0)
        {
            ...
            System.out.println("The Project #4 command-line interface has been provided above.");
...
//                readme_option_num--;
//            }
//            //System.out.println("The Project #4 README has been provided above, (" + readme_option_num + ") times.");
//            return;
//        }
        ...
        {
            System.err.println("[Main Date Initialization #1a] Error when attempting to format the departure time & date arguments, " + landing[3] + ", " + landing[4] + ", and " + landing[5] + ".");
...
//        }
        ...
        {
            System.err.println("[Main Date Initialization #1b] Error when attempting to format the arrival time & date arguments, " + landing[7] + ", " + landing[8] + ", and " + landing[9] + ".");
